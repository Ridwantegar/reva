module.exports = {
	...
	adminId: "1092542620372312074", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTA5NzQyNjIyMzc5MTA4NzY4Ng.GmoNQH.PdL7YcQgOTMqBk3KCZ3s_aLHjVQq7MUSTSQNRw", //- Bot's Token
	clientId: process.env.clientId || "1097426223791087686", //- ID of the bot
	clientSecret: process.env.clientSecret || "edb8e662552ac0d36d8af502163888e0eea1ef70dcc1f6bd8b1b9eafe5ffbe02", //- Client Secret of the bot
